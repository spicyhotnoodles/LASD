...
void stestHashTableInt(uint& testnum, uint& testerr) {
  ...
  try {
    ...
    lasd::HashTableOpnAdr<int> htopnadr(83, vec); // * Questo era commentato
    ...
    lasd::HashTableOpnAdr<int> cophtopnadr(htopnadr); // * Questo era commentato
...
void stestHashTableFloat(uint& testnum, uint& testerr) {
  ...
  try {
    ...
    lasd::HashTableOpnAdr<double> htopnadr(83, lst); // * Questo era commentato
    ...
    lasd::HashTableOpnAdr<double> cophtopnadr(htopnadr); // * Questo era commentato
    EqualHT(loctestnum, loctesterr, cophtopnadr, htopnadr);
    htopnadr.Clear();
    NonEqualHT(loctestnum, loctesterr, cophtopnadr, htopnadr);
    htopnadr = std::move(cophtopnadr);
...
void stestHashTableString(uint& testnum, uint& testerr) {
  ...
  try {
    ...
    lasd::HashTableOpnAdr<string> htopnadr(101, vec); // * Questo era commentato
    ...
    lasd::HashTableOpnAdr<string> cophtopnadr(htopnadr); // * Questo era commentato
    EqualHT(loctestnum, loctesterr, cophtopnadr, htopnadr);
    htopnadr.Clear();
    NonEqualHT(loctestnum, loctesterr, cophtopnadr, htopnadr);
    htopnadr = std::move(cophtopnadr);
