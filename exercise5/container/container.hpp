...
public:
  ...
  void Insert(const LinearContainer<Data>&); // Copy of the value. From LinearContainer
  void Insert(LinearContainer<Data>&&); // Move of the value. From LinearContainer
  void Remove(const LinearContainer<Data>&); // From LinearContainer
